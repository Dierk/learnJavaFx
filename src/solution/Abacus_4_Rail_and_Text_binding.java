...
public class Abacus_4_Rail_and_Text_binding extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("JavaFX Abacus with Binding");
        Pane root = new Pane();
        ...
        for (int row = 0; row < ROW_COUNT; row++) {
            ...
            for (int column = 0; column < COL_COUNT; column++) {
                ...
                Text text = new Text(circle.getCenterX()-3, circle.getCenterY()+4, ""+ ((COL_COUNT - column) % COL_COUNT));
